...
public:
    ...
    class ABaseUnit* SpawnUnit(TSubclassOf<class ABaseUnit> UnitClass, FVector Location);
...
private:
	...
	TSubclassOf<class ABaseUnit> WorkerClass;
    ...
    void SpawnInitialUnits(FVector CenterLocation);
};
